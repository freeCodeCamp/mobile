...
import 'package:freecodecamp/ui/views/code_radio/code_radio_view.dart' as _i12;
...
import 'package:freecodecamp/ui/views/learn/learn-builders/superblock_builder.dart'
    as _i13;
import 'package:freecodecamp/ui/views/learn/learn/learn_view.dart' as _i17;
...
import 'package:freecodecamp/ui/views/podcast/podcast-list/podcast_list_view.dart'
    as _i3;
import 'package:freecodecamp/ui/views/profile/profile_view.dart' as _i15;
...
import 'package:freecodecamp/ui/views/settings/podcastSettings/podcast_settings_view.dart'
    as _i4;
import 'package:freecodecamp/ui/views/web_view/web_view_view.dart' as _i16;
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      ...
      page: _i11.ForumSettingsView,
    ),
    _i1.RouteDef(
      Routes.codeRadioView,
      page: _i12.CodeRadioView,
    ),
    _i1.RouteDef(
      Routes.superBlockView,
      page: _i13.SuperBlockView,
    ),
    _i1.RouteDef(
      Routes.challengeView,
      page: _i14.ChallengeView,
    ),
    _i1.RouteDef(
      Routes.profileView,
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i11.ForumSettingsView: (data) {
      return MaterialPageRoute<dynamic>(
        builder: (context) => const _i11.ForumSettingsView(),
        settings: data,
      );
    },
    _i12.CodeRadioView: (data) {
      return MaterialPageRoute<dynamic>(
        builder: (context) => const _i12.CodeRadioView(),
        settings: data,
      );
    },
    _i13.SuperBlockView: (data) {
      final args = data.getArgs<SuperBlockViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) => _i13.SuperBlockView(
            key: args.key,
    ...
    _i16.WebViewView: (data) {
      final args = data.getArgs<WebViewViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) => _i16.WebViewView(key: args.key, url: args.url),
        settings: data,
      );
    },
    _i17.LearnView: (data) {
      return MaterialPageRoute<dynamic>(
        builder: (context) => const _i17.LearnView(),
        settings: data,
      );
    },
  };
