...
import 'package:freecodecamp/models/news/bookmarked_article_model.dart' as _i25;
...
import 'package:freecodecamp/ui/views/code_radio/code_radio_view.dart' as _i16;
...
import 'package:freecodecamp/ui/views/podcast/podcast-list/podcast_list_view.dart'
    as _i3;
import 'package:freecodecamp/ui/views/profile/profile_view.dart' as _i19;
import 'package:freecodecamp/ui/views/web_view/web_view_view.dart' as _i20;
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      ...
      page: _i5.NewsArticleView,
    ),
    _i1.RouteDef(
      Routes.newsBookmarkPostView,
      page: _i6.NewsBookmarkPostView,
    ),
    _i1.RouteDef(
      Routes.newsFeedView,
    ...
    _i1.RouteDef(
      ...
      page: _i10.ForumCategoryView,
    ),
    _i1.RouteDef(
      Routes.forumPostFeedView,
      page: _i11.ForumPostFeedView,
    ),
    _i1.RouteDef(
      Routes.forumPostView,
      page: _i12.ForumPostView,
    ),
    _i1.RouteDef(
      Routes.forumLoginView,
      page: _i13.ForumLoginView,
    ),
    _i1.RouteDef(
      Routes.forumUserView,
      page: _i14.ForumUserView,
    ),
    _i1.RouteDef(
      Routes.forumUserProfileView,
      page: _i15.ForumUserProfileView,
    ),
    _i1.RouteDef(
      Routes.codeRadioView,
      page: _i16.CodeRadioView,
    ),
    _i1.RouteDef(
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i5.NewsArticleView: (data) {
      final args = data.getArgs<NewsArticleViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i5.NewsArticleView(key: args.key, refId: args.refId),
        settings: data,
      );
    },
    _i6.NewsBookmarkPostView: (data) {
      final args = data.getArgs<NewsBookmarkPostViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i6.NewsBookmarkPostView(key: args.key, article: args.article),
        settings: data,
      );
    },
    ...
    _i10.ForumCategoryView: (data) {
      final args = data.getArgs<ForumCategoryViewArguments>(
        orElse: () => const ForumCategoryViewArguments(),
      );
      return MaterialPageRoute<dynamic>(
        builder: (context) => _i10.ForumCategoryView(key: args.key),
        settings: data,
      );
    },
    _i11.ForumPostFeedView: (data) {
      final args = data.getArgs<ForumPostFeedViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) => _i11.ForumPostFeedView(
            key: args.key, slug: args.slug, id: args.id, name: args.name),
        settings: data,
      );
    },
    _i12.ForumPostView: (data) {
      final args = data.getArgs<ForumPostViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i12.ForumPostView(key: args.key, id: args.id, slug: args.slug),
        settings: data,
      );
    },
    _i13.ForumLoginView: (data) {
      final args = data.getArgs<ForumLoginViewArguments>(
        orElse: () => const ForumLoginViewArguments(),
      );
      return MaterialPageRoute<dynamic>(
        builder: (context) => _i13.ForumLoginView(
            key: args.key, fromCreatePost: args.fromCreatePost),
        settings: data,
      );
    },
    _i14.ForumUserView: (data) {
      final args = data.getArgs<ForumUserViewArguments>(nullOk: false);
      return MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i14.ForumUserView(key: args.key, username: args.username),
        settings: data,
      );
    },
    _i15.ForumUserProfileView: (data) {
      return MaterialPageRoute<dynamic>(
        builder: (context) => const _i15.ForumUserProfileView(),
        settings: data,
      );
    },
    _i16.CodeRadioView: (data) {
      return MaterialPageRoute<dynamic>(
        builder: (context) => const _i16.CodeRadioView(),
        settings: data,
      );
    },
    ...
    _i20.WebViewView: (data) {
      ...
      return MaterialPageRoute<dynamic>(
        builder: (context) => _i20.WebViewView(key: args.key, url: args.url),
        settings: data,
      );
    },
...
extension NavigatorStateExtension on _i27.NavigationService {
  ...
  Future<dynamic> navigateToNewsBookmarkPostView({
    _i22.Key? key,
    required _i25.BookmarkedArticle article,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
