...
import 'package:freecodecamp/ui/views/rpg/rpg_view.dart' as _i18;
...
class Routes {
  ...
  static const rPGView = '/r-pg-view';
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i18.RPGView: (data) {
      return _i19.MaterialPageRoute<dynamic>(
        builder: (context) => const _i18.RPGView(),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i24.NavigationService {
  ...
  Future<dynamic> navigateToRPGView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.rPGView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithRPGView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.rPGView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
