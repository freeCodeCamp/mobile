...
class SymbolSettingsWidget extends StatelessWidget {
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () =>
                          _showCreateCustomSetDialog(context, model),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () =>
                            _showResetConfirmDialog(context, model),
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (symbols.isEmpty) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text('Please enter at least one symbol')),
                );
                return;
              }
  ...
  void _showEditCustomSetDialog(
    ...
    final symbolsController =
        TextEditingController(text: set.symbols.join(', '));
