...
class PassWidgetView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PassWidgetView> createState() => _PassWidgetViewState();
}

class _PassWidgetViewState extends ConsumerState<PassWidgetView> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(passWidgetModelProvider).initQuoute();
    });
  }

  @override
  Widget build(BuildContext context) {
    final model = ref.watch(passWidgetModelProvider);
    return SafeArea(
      child: Column(
        children: [
          Row(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    StreamBuilder<bool>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (AuthenticationService.staticIsloggedIn &&
                            !widget.challengeModel.isDailyChallenge) {
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: LinearProgressIndicator(
                                        value: completed / widget.maxChallenges,
                                        minHeight: 7,
                    ...
                    FutureBuilder(
                      future:
                          model.numCompletedChallenges(widget.challengeModel),
                      builder: (context, completedSnapshot) {
                        if (completedSnapshot.hasData) {
                          int completed = completedSnapshot.data as int;
                          return PassButton(
                            model: widget.challengeModel,
                            maxChallenges: widget.maxChallenges,
