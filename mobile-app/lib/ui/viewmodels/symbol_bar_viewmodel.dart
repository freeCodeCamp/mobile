...
class SymbolBarViewModel extends BaseViewModel {
  ...
  List<CustomSymbolSet> get customSymbolSets => _symbolBarService.state.customSymbolSets;
  ...
  bool isValidSymbolList(List<String> symbols) {
    return symbols.isNotEmpty && symbols.length <= 50 && symbols.every(isValidSymbol);
  }
}
